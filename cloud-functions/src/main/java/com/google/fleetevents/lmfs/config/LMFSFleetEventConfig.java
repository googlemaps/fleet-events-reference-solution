...
package com.google.fleetevents.lmfs.config;
 ...
 */
public final class LMFSFleetEventConfig {
  private static final Logger logger = Logger.getLogger(LMFSFleetEventConfig.class.getName());
