...
Vehicles and Tasks in the On Demand Rides and Deliveries (ODRD) product.
...
- **VehicleFleetEvents** have information related to eta, distance,
  ...
  executing.
- **TripFleetEvents** have information related solely to the task such
  as state, trip outcome, name, id, etc. ETA and distance updates are not
